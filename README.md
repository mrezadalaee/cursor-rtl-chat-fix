...
| [`deepseek-harness-rtl.js`](deepseek-harness-rtl.js) | **DeepSeek Harness** Web GUI | Smart per-element RTL detection |
...
1. Open the [`deepseek-harness-rtl.js`](deepseek-harness-rtl.js) file and copy its content.
2. Open **DeepSeek Harness** Web GUI.
3. Press `F12` or `Ctrl + Shift + I` to open Developer Tools.
4. Go to the **Console** tab, paste the code, and press **Enter**.
